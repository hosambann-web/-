...
// ⛔ رسالة الترحيب معطّلة بطلب المستخدم (19 يوليو 2026). الكود الأصلي محفوظ بالتعليق
// تحت لو حبيت ترجعها بالمستقبل - بس شيل /* و */ اللي حوله.
...
// ⛔ رسالة الوداع معطّلة بطلب المستخدم (19 يوليو 2026). الكود الأصلي محفوظ بالتعليق
// تحت لو حبيت ترجعها بالمستقبل - بس شيل /* و */ اللي حوله.
...
client.on('group_update', async (notification) => {
  try {
    ...
    // ⛔ الترحيب معطّل بطلب المستخدم (19 يوليو 2026) - هذا كان مسار احتياطي فقط
    if (notification.type === 'add') {
      return;
    }

    // -------- مسار احتياطي: عضو اتشال/طلع (remove) --------
    // ⛔ الوداع معطّل بطلب المستخدم (19 يوليو 2026) - هذا كان مسار احتياطي فقط
...
> *ᴘᴏᴡᴇʀᴇᴅ:* *Naruto Bot*`;
    ...
    // ⛔ أمر !xp معطّل بطلب المستخدم (19 يوليو 2026). لو حبيت ترجعه بالمستقبل، شيل
    // /* و */ اللي حوله (تحت هذا التعليق).
    /*
