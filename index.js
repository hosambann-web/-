...
client.on('message', async (message) => {
  try {
    ...
    if (body.startsWith('!مخالفة') || body.startsWith('!مخالفه')) {
      ...
      try {
        await client.sendMessage(targetId, violationDmBanner(reason, `@${target.number}`, newCount, MAX_WARNINGS));
      } catch (dmErr) {
    ...
    if (body === '!اوامر') {
      ...
      const header = `*🔥 HUSAAM BOT — قائمة الأوامر*
_V1.0 · يعمل ⚡_
━━━━━━━━━━━━━━
...
▸ !مراد [سؤال] — اسأل مراد
▸ !xp — نشاطك بالجروب
▸ !صوت [نص] — تحويل نص لصوت
▸ !بروفايل [@شخص] — صورة العضو
▸ !رابط — رابط الجروب

*🎮 تسلية*
▸ !تحدي — تريفيا + XP
▸ !دين — سؤال ديني + XP
▸ !من_فينا — سؤال مرح عشوائي
...
*👑 إدارة*
▸ !قفل / !فتح — قفل/فتح الدردشة
▸ !قفل رابط / !فتح رابط — منع الروابط
▸ !باند @شخص — حظر
▸ !اصعد / !انزل @شخص — أدمن
▸ !توقف / !تشغيل — تشغيل/إيقاف مراد
▸ !ازالة_تحذير @شخص — حذف تحذير
▸ !مخالفة @شخص [السبب] — تحذير يدوي`;

      const footer = `
━━━━━━━━━━━━━━
_اكتب !اوامر بأي وقت لعرض هالقائمة_`;
